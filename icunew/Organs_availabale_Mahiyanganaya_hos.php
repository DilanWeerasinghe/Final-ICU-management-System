...
if (!$conn) {
 ...
 $sql = "SELECT `hos_name`,`hos_lat`, `hos_long`, `hos_address`, `hos_city`, `hos_contact` FROM `hospital_mahiyanganaya` WHERE `hos_ambulance`>0";
        ...
        <div>
            <div class="col-sm-3 text-left nav-pill-bg-danger">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li ><a id="ambulance" href="#">Nearest Availabale organs @ </a></li>
