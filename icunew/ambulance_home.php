...
#im5{<img src="assets/img/check.jpg>}
 ...
 <div>
     ...
     <div id="im5"> 
            <br>
            <h1 style="color:black;text-align:center;" >Ambulance Dashbord</h1>
                    ...
                    <div class="w3-card" style="height:180px">
                        <div class="container">
                            ...
                            <div class="w3-container" style="color:black">
                             ...
                             <a href="search_ambulance.php">   <button class="w3-button w3-black">Search</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w3-third w3-hover-opacity">
                    <div class="w3-card" style="height:180px">
                        <div class="container">
                            ...
                            <br><br>
                            <div class="w3-container" style="color:black">
                                <h4>Update Ambulance Details</h4>
                               <a href="icu_ambulance.php"> <button onclick="document.getElementById('id02').style.display='block'" class="w3-button w3-blue">Update</button></a>
                            </div>
                        </div>
                    </div>
                </div>
               <div style="padding-top:230px">
                   <a href="ambulance_map.php"> <button class="w3-button w3-blue">View Nearest Ambulance </button></a>
               </div>
