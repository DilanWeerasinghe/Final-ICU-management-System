...
if (!$conn) {
 ...
 $sql = "SELECT `hos_name`,`hos_lat`, `hos_long`, `hos_address`, `hos_city`, `hos_contact` FROM `hospital` WHERE `hos_icubeds`>0";
...
?> 
        ...
        <div>
            <div class="col-sm-3 text-left nav-pill-bg-danger">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li ><a id="icubeds" href="#">Nearest ICU beds </a></li>
        ...
        var onChangeHandler = function() {
		  ...
		  for (i = 0; i < locations.length; i++) {
		   ...
		   document.getElementById('request').style.visibility='visible';
			  ...
			  document.getElementById('floating-panel').innerHTML ("There are no available ICU beds at the moment");
		...
		var onClickSendSMS = function() {
			console.log(number);
			var text = "A Request logged for a ICU bed from Badulla Hospital , Thanks ";
    ...
    return xmlHttp.responseText;
        ...
        document.getElementById('icubeds').addEventListener('click', onChangeHandler);
	  ...
	  function calculateDistance(distanceService,latlang,index) {
        ...
        //  destination:  {lat: 6.9707538, lng: 81.0327561},
          ...
          if (status === 'OK') {
            ...
            outputDiv.innerHTML = 'Nearest ICU bed @ '+latlang[index] +
