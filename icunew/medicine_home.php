...
#im5{<img src="assets/img/check.jpg>}
 ...
 <div>
     ...
     <div id="im5"> 
            <br>
            <h1 style="color:black;text-align:center;" >Medicine Dashbord</h1>
                    ...
                    <div class="w3-card" style="height:180px">
                        <div class="container">
                            ...
                            <div class="w3-container" style="color:black">
                                ...
                                <a href="search_medicine.php"><button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-black">Search</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="w3-card" style="height:180px">
                        <div class="container">
                            ...
                            <div class="w3-container" style="color:black">
                                ...
                                <a href="icu_medicine.php"><button onclick="document.getElementById('id02').style.display='block'" class="w3-button w3-blue">Update</button></a>
                            </div>
                        </div>
                    </div>
                </div>
