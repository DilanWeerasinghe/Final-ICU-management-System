...
#im5{<img src="assets/img/check.jpg>}
 ...
 <div>
     ...
     <div id="im6"> 
            <br>
            <h1 style="color:black;text-align:center;" >Doctors Info Dashbord</h1>
                    ...
                    <div class="w3-card" style="height:180px">
                        <div class="container">
                            ...
                            <div class="w3-container" style="color:black">
                                <h4>Search Doctors Info</h4>
                                <a href="search_doc.php"><button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-black">Search</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w3-third ">
                    <div class="w3-card" style="height:180px">
                        <div class="container">
                            ...
                            <br><br>
                            <div class="w3-container" style="color:black">
                                <h4>Update Doctors Info </h4>
                                <a href="docavb.php"><button onclick="document.getElementById('id02').style.display='block'" class="w3-button w3-blue">Update</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="w3-third ">
                    <div class="w3-card" style="height:180px">
                        <div class="container">
                            ...
                            <br><br>
                            <div class="w3-container" style="color:black">
                                <h4>Insert Doctors Info</h4>
                                <a href="insert.php"><button onclick="document.getElementById('id02').style.display='block'" class="w3-button w3-green">Insert</button></a>
                            </div>
                        </div>
                    </div>
                </div>
