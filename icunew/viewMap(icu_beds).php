...
if (!$conn) {
 ...
 $sql = "SELECT `hos_name`,`hos_lat`, `hos_long`, `hos_address`, `hos_city`, `hos_contact` FROM `hospital_icu_beds` WHERE `hos_icu_beds`>0";
        ...
        <div>
            <div class="col-sm-3 text-left nav-pill-bg-danger">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><a id="ambulance" href="#"><h3>View Nearest ICU Beds</h3>  </a></li>
